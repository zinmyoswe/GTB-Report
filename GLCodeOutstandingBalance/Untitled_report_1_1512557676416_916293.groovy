/*
 * Generated by JasperReports - 12/6/17 5:24 PM
 */
 ...
 *
 */
class Untitled_report_1_1512557676416_916293 extends JREvaluator
{
    ...
    Object evaluate(int id)
    {
        ...
        {
            value = (java.lang.String)(((java.lang.String)parameter_P_vi_TranDate.getValue()) + "!" +((java.lang.String)parameter_P_vi_acct_id.getValue()));
        }
        else if (id == 7)
        {
