/*
 * Generated by JasperReports - 12/6/17 2:36 PM
 */
 ...
 *
 */
class AccountOpenListing_1512547565368_242909 extends JREvaluator
{
...
"Office":"Unknown")+" Account Opening (All) From "+((java.lang.String)parameter_P_StartDate.getValue())+" To "+((java.lang.String)parameter_P_EndDate.getValue()));
        ...
        {
            value = (java.lang.String)(((java.lang.String)field_ImageName.getValue()));
        }
        else if (id == 31)
        {
...
"Office":"Unknown")+" Account Opening (All) From "+((java.lang.String)parameter_P_StartDate.getValue())+" To "+((java.lang.String)parameter_P_EndDate.getValue()));
        ...
        {
            value = (java.lang.String)(((java.lang.String)field_ImageName.getOldValue()));
        }
        else if (id == 31)
        {
