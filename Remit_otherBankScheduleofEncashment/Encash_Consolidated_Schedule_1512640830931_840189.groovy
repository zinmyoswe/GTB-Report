/*
 * Generated by JasperReports - 12/7/17 4:30 PM
 */
 ...
 *
 */
class Encash_Consolidated_Schedule_1512640830931_840189 extends JREvaluator
{
    ...
    Object evaluate(int id)
    {
        ...
        {
            value = (java.lang.String)("CUSTOM|FIN_ENCASH_CONSOL_SCHEDULE.FIN_ENCASH_CONSOL_SCHEDULE%3%CUSTOM::|where%vi_TranDate%=%((java.lang.String)parameter_P_vi_TranDate.getValue())%Parameter%Date::and%vi_other_bank%=%((java.lang.String)parameter_P_vi_other_bank.getValue())%Parameter%String::|INP_STR%1%java.lang.String%VARCHAR2::OUT_RETCODE%4%java.math.BigDecimal%NUMBER::OUT_REC%4%java.lang.String%VARCHAR2::|P_vi_TranDate%java.sql.Timestamp%10%!NULL!%Transaction Date@DBQUERY%NONE%java.sql.Timestamp!@!DEFAULT!@!8!@!10%CONSTANT%N%N::P_vi_other_bank%java.lang.String%100%!NULL!%Other Bank@DBQUERY%NONE%java.lang.String!@!SET!@!0!@!100&!&KBZ#@#AYA#@#MWD#@#CB#@#SMIDB#@#RDB#@#CHDB#@#Innwa#@#Shwe#@#MABL#@#May(MALAYSIA)#@#May(SINGAPORE)#@#UOB#@#DBS#@#BKK#@#OCBC#@#SIAM#@#AGD%CONSTANT%N%N::|{call CUSTOM.FIN_ENCASH_CONSOL_SCHEDULE.FIN_ENCASH_CONSOL_SCHEDULE( ((java.lang.String)parameter_FIN_INP_STR.getValue())  , ((java.math.BigDecimal)parameter_FIN_OUT_RETCODE.getValue()) , ((java.lang.String)parameter_FIN_OUT_REC.getValue()) ) } |{call CUSTOM.FIN_ENCASH_CONSOL_SCHEDULE.FIN_ENCASH_CONSOL_SCHEDULE( ((java.lang.String)parameter_FIN_INP_STR.getValue())  , ((java.math.BigDecimal)parameter_FIN_OUT_RETCODE.getValue()) , ((java.lang.String)parameter_FIN_OUT_REC.getValue()) ) } |false");
        }
        else if (id == 7)
        {
        ...
        {
            value = (java.math.BigDecimal)(((java.lang.String)parameter_P_vi_other_bank.getValue()) == "KBZ" ? 
(((java.math.BigDecimal)field_v_drawing_amt.getValue())== null ? 0.00 : (((java.math.BigDecimal)field_v_drawing_amt.getValue())*60/100))
 : (((java.math.BigDecimal)field_v_drawing_amt.getValue())== null ? 0.00 : (((java.math.BigDecimal)field_v_drawing_amt.getValue())*50/100)));
        }
        else if (id == 22)
        {
        ...
        {
            value = (java.lang.String)("CONSOLIDATED SCHEDULE OF ENCASH ON " + ((java.lang.String)parameter_P_vi_other_bank.getValue()) + " BANK LTD.");
        }
        else if (id == 36)
        {
    ...
    Object evaluateOld(int id)
    {
        ...
        {
            value = (java.math.BigDecimal)(((java.lang.String)parameter_P_vi_other_bank.getValue()) == "KBZ" ? 
(((java.math.BigDecimal)field_v_drawing_amt.getOldValue())== null ? 0.00 : (((java.math.BigDecimal)field_v_drawing_amt.getOldValue())*60/100))
 : (((java.math.BigDecimal)field_v_drawing_amt.getOldValue())== null ? 0.00 : (((java.math.BigDecimal)field_v_drawing_amt.getOldValue())*50/100)));
        }
        else if (id == 22)
        {
